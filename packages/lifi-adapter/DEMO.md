...
- Use the mock demo for CI or when you want deterministic output.
- Use the live demo to inspect real provider data, but be mindful of rate limits and network flakiness.

If you need help running the demos, open an issue or ask for the specific command for your environment.
